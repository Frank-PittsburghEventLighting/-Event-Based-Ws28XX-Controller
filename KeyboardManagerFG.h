...
#ifndef _KEYBOARD_MANGER_H_A
#define _KEYBOARD_MANGER_H_A
...
/**
 *  My Keypad  Pittsburgh Event Lighitng  ADJ  Led WS28xx Controller
 */
#define MAKE_KEYBOARD_LAYOUT_3X8(varName) const char KEYBOARD_STD_3X8_KEYS[] PROGMEM = "123456789X0YAEIBFJDHLCGK"; KeyboardLayout varName(8, 3, KEYBOARD_STD_3X8_KEYS);

#endif // _KEYBOARD_MANGER_H_A
