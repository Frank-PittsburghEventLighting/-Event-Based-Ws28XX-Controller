...
#define MASTER_Speed 1003       //   Adjusted for +20 Offset
...
uint8_t taskId = taskManager.scheduleFixedRate(50, LoopFLed);;
uint8_t taskId2 = taskManager.scheduleFixedRate(50, LoopFLed2);;
